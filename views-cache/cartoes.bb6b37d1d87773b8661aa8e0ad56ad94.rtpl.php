    ...
    <section>
        ...
        <div class="container">
                <div class="mx-auto mb-4 col-xs-6 col-sm-6 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                    <input type="number" name="inicial" id="idnuminicial" class="form-control mb-4" placeholder="Número inicial">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>       
                            ...
                            <td class="text-center"><a href="/cartao/deletar/<?php echo htmlspecialchars( $value1["idcartao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente deletar a comanda <?php echo htmlspecialchars( $value1["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')"><i
