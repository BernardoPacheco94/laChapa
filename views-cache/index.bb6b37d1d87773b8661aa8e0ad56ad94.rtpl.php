...
<section class="container-fluid m-2 mx-auto">
    <div class="row">
        <div id="div-btn-adc-mesa" class="col-3">
            <button class="btn btn-dark" type="button" id="btn-adc-comanda" onclick="adcMesa()">
                Adicionar Mesa
            </button>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="accordion m-2" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="comanda_i" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-dark" id="btn-adc-comanda" data-bs-toggle="modal" data-bs-target="#modal_lanca_comanda">
                                            Novo Produto
                                        </button>
                                    </div>
                                </div>
                            ...
                            <table class="table table-light table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Pão</td>
                                        <td>1x</td>
                                        <td class="text-center"><a href=""><i class="fa-solid fa-circle-plus text-success fa-2x"></i></a>
                                        </td>
                                        <td class="text-center"><a href=""><i class="fa-solid fa-circle-minus text-warning fa-2x"></i></a>
                                        </td>
                                        <td>R$ 0,00</td>
                                    </tr>
