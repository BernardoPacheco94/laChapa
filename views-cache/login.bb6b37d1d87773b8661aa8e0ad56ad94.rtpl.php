...
<body class="min-vh-100 vh-100 bg-black container-fluid text-center row align-items-center">
    <div>
        ...
        <form class="form container-fluid col-xs-12 xol-sm-12 col-md-10 col-lg-8 col-xl-8 col-xxl-6 p-3"
            action="/login" method="POST">
            <i class="fa-solid fa-user fa-4x text-white mb-3"></i>
            <br>
            <input class="col-xs-10 col-sm-12 col-md-6 col-lg-6 col-xl-5 col-xxl-4 m-1" type="text" name="nome" id="nome"
                placeholder="Nome" required>
            <br>
            <input class="col-xs-10 col-sm-12 col-md-6 col-lg-6 col-xl-5 col-xxl-4 m-1" type="password" name="passhash"
        ...
        <div class="col-xs-10 col-sm-12 col-md-6 col-lg-6 col-xl-5 col-xxl-4 mt-3 container text-light bg-secondary rounded">
                <?php if( $error ){ ?>
                <p>
